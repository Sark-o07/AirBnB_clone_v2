...
HolbertonBnB is a dynamic RESTful web app with integrated file and MySQL database storage. The back-end API, powered by Python Flask, interfaces with a sleek HTML5/CSS3 front-end. Configured on a distributed system with Nginx and HAProxy, the project is actively developing with upcoming features:

* RESTful API Integration
* Full Website Configuration with Domain Name
* Dynamic Content Serving with JavaScript
